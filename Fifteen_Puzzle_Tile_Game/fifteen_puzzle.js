...
const winningAudio = new Audio("./audio/winSound.mp3");
ceation_slots();
...
function check_slots(){
    ...
    }if(check==o){setTimeout(()=>{ winningAudio.play(); alert('Hurray You Won'); },((p.time)?p.time*1000:0));} // <-- alert('win') script that runs at the end of the game setTimeout(function(){alert("Thank you!")},1000);
}
